...
public class StaffServiceImpl implements StaffService {
  ...
  public ResponseEntity<Map<String, Object>> registerStaff(StaffDto staff) {
    ...
    public ResponseEntity<List<StaffDto>> listStaff() {
      ...
      return new ResponseEntity<List<StaffDto>>(list, HttpStatus.OK);
  }
  
  @Override
  public ResponseEntity<StaffDto> searchStaff(String sno) {
    StaffDto staffDto = new StaffDto(); 
     staffDto = staffMapper.getStaff(sno);
     System.out.println(staffDto + sno);
