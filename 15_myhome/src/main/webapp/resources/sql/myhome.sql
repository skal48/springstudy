...
SELECT SUBSTR(IMAGE_PATH,7), TO_CHAR(SYSDATE, 'YYYY/MM/DD')
  FROM BLOG_IMAGE_T;
...
INSERT INTO USER_T VALUES(USER_SEQ.NEXTVAL, 'user2@naver.com', STANDARD_HASH('2222', 'SHA256'), '사용자2', 'F', '01022222222', '22222', '디지털로', '가산동', '101동 101호', 0, 0, TO_DATE('20220801', 'YYYYMMDD'), TO_DATE('20220101', 'YYYYMMDD'));
...
-- 첨부 테이블 정보를 조회하지 않는다면 업로드 게시글과 첨부의 조인은 제거하고 작없을 수행할 수 있다. 
