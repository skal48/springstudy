...
<div>
  ...
  <form id="frm_blog_add" method="post" action="${contextPath}/blog/addBlog.do"> <!-- 폼아이디는 나중에 제목 공백으로 넣지 않기위한 스크립트 짤때 필요 -->
    ...
    <button type="submit" class="btn btn-outline-primary me-md-2">작성완료</button>
    </div>
